...
class GraphAlgo_test(TestCase):
    ...
    def test_load_from_json(self):
        self.assertTrue(self.ga.load_from_json("../data/A0.json"))
        print(self.ga.get_graph())
        self.assertTrue(self.ga.load_from_json('../data/A5.json'))
        print(self.ga.get_graph())
    ...
    def test_save_to_json(self):
        ...
        self.assertTrue(self.ga.load_from_json("../data/A1.json"))
